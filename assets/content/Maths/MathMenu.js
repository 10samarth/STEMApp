const mathsData = [
  {
    ...
    imageWork:
      "https://wp.bcamath.org/news/wp-content/uploads/sites/24/2021/02/Dorothy-Vaughan_WP-1200x700.png",
    imageLegacy:
      "https://upload.wikimedia.org/wikipedia/commons/9/93/L_Dorothy_Vaughan_M_Lessie_Hunter_R_Vivian_Adair.jpg",
    links: [
      "https://en.wikipedia.org/wiki/Dorothy_Vaughan",
      "https://wp.bcamath.org/news/en/2021/02/26/the-scientists-who-inspired-us-x-dorothy-vaughan/",
...

  {
    ...
    cardA:
      "He was educated at Cambridge University (1661–65), where he discovered the work ofRené Descartes. His experiments passing sunlight through a prism led to the discovery of the heterogeneous, corpuscular nature of white light and laid the foundation of physical optics. He built the first reflecting telescope in 1668and became a professor of mathematics at Cambridge in 1669. He worked out the fundamentals of calculus, though this work went unpublished for more than 30 years. His most famous publication, Principia Mathematica (1687), grew out of correspondence with Edmond Halley. Describing his works on the laws of motion(see Newton's laws of motion), orbital dynamics, tidal theory, and the theory of universal gravitation, it is regarded as the seminal work of modern science. He was elected president of the Royal Society of London in 1703 and became the first scientist to be knighted in 1705. During his career, he engaged in heated arguments with several of his colleagues, including Robert Hooke (over authorship of the inverse square relation of gravitation) and G.W. Leibniz(over the authorship of calculus). The battle with Leibniz dominated the last25 years of his life; it is now well established that Newton developed calculus first, but that Leibniz was the first to publish on the subject. Newton is regarded as one of the greatest scientists of all time.",
    cardB:
      "Isaac Newton changed the way we understand the Universe. Revered in his own lifetime, he discovered the laws of gravity and motion and invented calculus. He helped shape our rational worldview. But Newton's story is also one of a monstrous ego who believed that he alone was able to understand God's creation.",
    imageWork:
